...
export const config = {
  matcher: [
    ...
    "/((?!_next/static|_next/image|favicon.ico|legal(?:/.*)?$|api/empresa/upload-logo|api/empresa/logo/|api/archivo/|api/sii-local/|api/extension/|api/telegram/|api/pagos/webhook|api/pagos/cron|api/ops/cron|api/document-processing/cron|api/audit/cron|.*\\.(?:svg|png|jpg|jpeg|gif|webp)$).*)",
  ],
};
