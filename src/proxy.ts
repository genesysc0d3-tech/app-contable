...
export const config = {
  matcher: [
    ...
    "/((?!_next/static|_next/image|favicon.ico|api/empresa/upload-logo|api/empresa/logo/|api/sii-local/|api/telegram/|api/pagos/webhook|api/pagos/cron|api/ops/cron|.*\\.(?:svg|png|jpg|jpeg|gif|webp)$).*)",
  ],
};
