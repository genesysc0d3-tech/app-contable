...
export type CuentaAuditAction =
  ...
  | "modo_soporte_salido"
  | "soporte_intervencion_solicitada"
  | "soporte_intervencion_autorizada"
  | "soporte_intervencion_escritura"
  | "soporte_intervencion_terminada"
  | "soporte_intervencion_revocada"
  | "documento_eliminado"
  | "documento_deshecho"
  | "documento_cancelado"
  | "plan_cambiado_dev"
