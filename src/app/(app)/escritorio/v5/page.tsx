...
.app{display:grid;grid-template-columns:minmax(0,1.7fr) minmax(0,8.3fr);max-width:1400px;margin:0 auto;gap:20px;height:calc(100vh - 94px);padding:0 0;position:relative;background:transparent;min-height:0;overflow:visible}
