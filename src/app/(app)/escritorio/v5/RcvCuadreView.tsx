    ...
    <div style={{ minHeight: 0, overflow: "auto", padding: "14px 18px 28px", background: "var(--surface)" }}>
      ...
      <div style={{ display: "flex", alignItems: "center", gap: 8, flexWrap: "wrap" }}>
        ...
        <div style={{ marginLeft: "auto", display: "flex", alignItems: "center", gap: 10, flexWrap: "wrap", padding: "7px 14px", border: "1px solid var(--border)", borderRadius: 12, background: "var(--bg-muted)" }}>
          ...
          {/* El amarillo continúa la misma fila, como una ficha más. */}
          <span title="Cuadre parcial: el RCV del SII aún no se descarga, y las boletas de hoy entran al cierre del día (vía RCOF). El cuadre definitivo queda al terminar el mes, antes del F29." style={{ display: "flex", alignItems: "center", gap: 5, padding: "4px 9px", border: "1px solid rgba(245,158,11,.28)", borderRadius: 999, background: "rgba(245,158,11,.06)", color: "var(--amber)", fontSize: 9, fontWeight: 850, whiteSpace: "nowrap" }}>
