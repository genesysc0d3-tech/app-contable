...
// La extensión se instala SOLO desde la Chrome Web Store (definición del fundador:
// "100% instalable desde Chrome Store"; se auto-actualiza). Sin archivo de descarga.
  ...
  return (
    <div className="eg-root">
      ...
      <div className="eg-wrap">
        ...
        <h1 className="eg-h1">Instala la extensión en 1 minuto</h1>
        <p className="eg-lead">
        ...
        <p className="eg-meta">
          ~1 minuto · una sola vez · se actualiza sola · Chrome, Edge o Brave
        </p>
