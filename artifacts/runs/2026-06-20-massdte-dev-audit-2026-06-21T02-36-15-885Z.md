...
kind: run
status: done
created_at: 2026-06-21T02:36:15.885Z
...
- Screenshots: /tmp/massdte-audit-2026-06-21T02-36-15-885Z
- Report: /Users/take/Desktop/app-contable/artifacts/runs/2026-06-20-massdte-dev-audit-2026-06-21T02-36-15-885Z.md
- Base status: 307
...
|---|---|---|---:|---:|---|---|
| dev-cuentas | ok | /dev/cuentas | 200 | 4272 | /tmp/massdte-audit-2026-06-21T02-36-15-885Z/01-dev-cuentas.png | no:Panel operador<br>yes:Account 360<br>yes:Ver cliente<br>yes:Detalle |
| dev-diagnostico | ok | /dev/diagnostico | 200 | 2021 | /tmp/massdte-audit-2026-06-21T02-36-15-885Z/02-dev-diagnostico.png | no:Diagnostico<br>yes:Genesys<br>no:operador |
| massdte | ok | /massdte | 200 | 5466 | /tmp/massdte-audit-2026-06-21T02-36-15-885Z/03-massdte.png | yes:Uso del mes<br>no:Equipo<br>no:Modo soporte Genesys<br>no:Cambiar empresa<br>no:Emitir bloqueado |
| empresa | ok | /empresa | 200 | 3032 | /tmp/massdte-audit-2026-06-21T02-36-15-885Z/04-empresa.png | yes:Empresa<br>yes:Datos del emisor<br>yes:Formatos de cartola<br>yes:Folios CAF<br>no:Agregar persona |
| revisar | ok | /revisar | 200 | 2314 | /tmp/massdte-audit-2026-06-21T02-36-15-885Z/05-revisar.png | yes:Revisar<br>yes:propuestas<br>yes:pendientes |
| subir | ok | /subir | 200 | 2799 | /tmp/massdte-audit-2026-06-21T02-36-15-885Z/06-subir.png | no:Subir<br>yes:documento<br>yes:cartola |
| clientes | ok | /clientes | 200 | 2236 | /tmp/massdte-audit-2026-06-21T02-36-15-885Z/07-clientes.png | yes:Clientes<br>yes:cliente |
| boletas-reportes | ok | /boletas/reportes | 200 | 2820 | /tmp/massdte-audit-2026-06-21T02-36-15-885Z/08-boletas-reportes.png | yes:Reporte RCV<br>yes:Registro de ventas |
| planes | ok | /planes | 200 | 2599 | /tmp/massdte-audit-2026-06-21T02-36-15-885Z/09-planes.png | no:Start<br>no:Pro<br>no:Business<br>yes:Mercado Pago |
| dev-cuenta-detalle | ok | /dev/cuentas/:uuid |  |  | /tmp/massdte-audit-2026-06-21T02-36-15-885Z/10-dev-cuenta-detalle.png | dynamic |
...
- Status: ok
- Screenshot: /tmp/massdte-audit-2026-06-21T02-36-15-885Z/01-dev-cuentas.png
- Page title: App Contable
- H1: Cuentas
- DOMContentLoaded ms: 2693
- Load event ms: 2795
...
- Storage keys: local=n/a; session=__next_debug_channel:BYVQeAItDV--TkGrw2Kv6
...
- Status: ok
- Screenshot: /tmp/massdte-audit-2026-06-21T02-36-15-885Z/02-dev-diagnostico.png
- Page title: App Contable
- H1: Diagnóstico de acceso dev
- DOMContentLoaded ms: 542
- Load event ms: 550
...
- Storage keys: local=n/a; session=__next_debug_channel:BYVQeAItDV--TkGrw2Kv6, __next_debug_channel:vdaRra0iVIQGaA3Y3-BbF
...
- Final path: /massdte
- Status: ok
- Screenshot: /tmp/massdte-audit-2026-06-21T02-36-15-885Z/03-massdte.png
- Page title: App Contable
- H1:
- DOMContentLoaded ms: 3030
- Load event ms: 3718
- Resource count from Performance API: 40
- Transfer size KB from Performance API: 768
- Visible text chars: 153464
- Scroll height / viewport: 900 / 900
...
- Allowed link labels: n/a
- Storage keys: local=n/a; session=__next_debug_channel:BYVQeAItDV--TkGrw2Kv6, __next_debug_channel:uTwIyPqbZngF_pQe17nUa, __next_debug_channel:vdaRra0iVIQGaA3Y3-BbF
...
- Final path: /empresa
- Status: ok
- Screenshot: /tmp/massdte-audit-2026-06-21T02-36-15-885Z/04-empresa.png
- Page title: App Contable
- H1: Empresa
- DOMContentLoaded ms: 913
- Load event ms: 1289
...
- Storage keys: local=n/a; session=__next_debug_channel:BYVQeAItDV--TkGrw2Kv6, __next_debug_channel:lbaKta2cctzooDusqyMeI, __next_debug_channel:uTwIyPqbZngF_pQe17nUa, __next_debug_channel:vdaRra0iVIQGaA3Y3-BbF
- Network total responses: 28
- Network status counts: 200:27, 304:1
- Network method counts: GET:28
- Network resource types: document:1, font:2, stylesheet:1, script:22, image:1, fetch:1
- Top endpoints:
  - 1x /_next/static/chunks/_1anvha4._.js
  - 1x /_next/static/chunks/%5Broot-of-the-server%5D__1athiux._.css
  - 1x /_next/static/chunks/%5Bturbopack%5D_browser_dev_hmr-client_hmr-client_ts_1mojsay._.js
...
- Final path: /revisar
- Status: ok
- Screenshot: /tmp/massdte-audit-2026-06-21T02-36-15-885Z/05-revisar.png
- Page title: App Contable
- H1: Revisar
- DOMContentLoaded ms: 811
- Load event ms: 858
...
- Allowed button labels: n/a
- Allowed link labels: Emitir, Revisar3, Empresa
- Storage keys: local=n/a; session=__next_debug_channel:BYVQeAItDV--TkGrw2Kv6, __next_debug_channel:lbaKta2cctzooDusqyMeI, __next_debug_channel:suPkCLWaQsaBiDTuLeEbe, __next_debug_channel:uTwIyPqbZngF_pQe17nUa, __next_debug_channel:vdaRra0iVIQGaA3Y3-BbF
...
- Final path: /subir
- Status: ok
- Screenshot: /tmp/massdte-audit-2026-06-21T02-36-15-885Z/06-subir.png
- Page title: App Contable
- H1: Emitir
...
- Allowed button labels: n/a
- Allowed link labels: Emitir, Revisar3, Empresa
- Storage keys: local=n/a; session=__next_debug_channel:BYVQeAItDV--TkGrw2Kv6, __next_debug_channel:lbaKta2cctzooDusqyMeI, __next_debug_channel:pYmmPj8qXo0wrBPloNTCB, __next_debug_channel:suPkCLWaQsaBiDTuLeEbe, __next_debug_channel:uTwIyPqbZngF_pQe17nUa, __next_debug_channel:vdaRra0iVIQGaA3Y3-BbF
- Network total responses: 29
- Network status counts: 200:9, 304:20
- Network method counts: GET:29
- Network resource types: document:1, font:2, stylesheet:1, script:23, fetch:2
- Top endpoints:
  - 1x /_next/static/chunks/_1anvha4._.js
  - 1x /_next/static/chunks/%5Broot-of-the-server%5D__1athiux._.css
  - 1x /_next/static/chunks/%5Bturbopack%5D_browser_dev_hmr-client_hmr-client_ts_1mojsay._.js
...
- Final path: /clientes
- Status: ok
- Screenshot: /tmp/massdte-audit-2026-06-21T02-36-15-885Z/07-clientes.png
- Page title: App Contable
- H1: Clientes
- DOMContentLoaded ms: 742
- Load event ms: 799
...
- Allowed button labels: n/a
- Allowed link labels: Emitir, Revisar3, Empresa
- Storage keys: local=n/a; session=__next_debug_channel:8gPxsKOUSTAI2BWWJH8w0, __next_debug_channel:BYVQeAItDV--TkGrw2Kv6, __next_debug_channel:lbaKta2cctzooDusqyMeI, __next_debug_channel:pYmmPj8qXo0wrBPloNTCB, __next_debug_channel:suPkCLWaQsaBiDTuLeEbe, __next_debug_channel:uTwIyPqbZngF_pQe17nUa, __next_debug_channel:vdaRra0iVIQGaA3Y3-BbF
- Network total responses: 25
- Network status counts: 200:5, 304:20
- Network method counts: GET:25
- Network resource types: document:1, font:2, script:21, stylesheet:1
- Top endpoints:
...
- Status: ok
- Screenshot: /tmp/massdte-audit-2026-06-21T02-36-15-885Z/08-boletas-reportes.png
- Page title: App Contable
- H1: Reporte RCV
- DOMContentLoaded ms: 894
- Load event ms: 925
- Resource count from Performance API: 25
...
- Allowed button labels: n/a
- Allowed link labels: Emitir, Revisar3, Empresa
- Storage keys: local=n/a; session=__next_debug_channel:8gPxsKOUSTAI2BWWJH8w0, __next_debug_channel:BYVQeAItDV--TkGrw2Kv6, __next_debug_channel:EW5RMZhU_OSCGWC1ixYhV, __next_debug_channel:lbaKta2cctzooDusqyMeI, __next_debug_channel:pYmmPj8qXo0wrBPloNTCB, __next_debug_channel:suPkCLWaQsaBiDTuLeEbe, __next_debug_channel:uTwIyPqbZngF_pQe17nUa, __next_debug_channel:vdaRra0iVIQGaA3Y3-BbF
- Network total responses: 26
- Network status counts: 200:6, 304:20
- Network method counts: GET:26
- Network resource types: document:1, font:2, stylesheet:1, script:21, fetch:1
- Top endpoints:
  - 1x /_next/static/chunks/_1anvha4._.js
...
- Final path: /planes
- Status: ok
- Screenshot: /tmp/massdte-audit-2026-06-21T02-36-15-885Z/09-planes.png
- Page title: App Contable
- H1: Planes
- DOMContentLoaded ms: 1125
- Load event ms: 1141
- Resource count from Performance API: 21
...
- Allowed link labels: n/a
- Storage keys: local=n/a; session=__next_debug_channel:8gPxsKOUSTAI2BWWJH8w0, __next_debug_channel:BYVQeAItDV--TkGrw2Kv6, __next_debug_channel:EW5RMZhU_OSCGWC1ixYhV, __next_debug_channel:lbaKta2cctzooDusqyMeI, __next_debug_channel:pYmmPj8qXo0wrBPloNTCB, __next_debug_channel:suPkCLWaQsaBiDTuLeEbe, __next_debug_channel:tenzZiPQ_oJoheTXvxfA2, __next_debug_channel:uTwIyPqbZngF_pQe17nUa, __next_debug_channel:vdaRra0iVIQGaA3Y3-BbF
- Network total responses: 22
...
|---|---|---|---|
| detalle-cuenta | pass | Detalle de cuenta carga con prioridad. | /tmp/massdte-audit-2026-06-21T02-36-15-885Z/10-dev-cuenta-detalle.png |
| modo-cliente-banner | pass | Banner de modo soporte visible. | /tmp/massdte-audit-2026-06-21T02-36-15-885Z/11-modo-cliente-massdte.png |
...
### Network Totals
- Total responses: 398
- Status counts: 200:170, 304:224, 403:4
...
- 2026-06-21T02:36:15.885Z: corrida generada por scripts/audit-app-devtools.mjs.
