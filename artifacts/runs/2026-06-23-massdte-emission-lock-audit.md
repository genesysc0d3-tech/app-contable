...
kind: run
status: done
created_at: 2026-06-23T05:54:11.638Z
...
- Tipo DTE: 39
- Screenshots: /tmp/massdte-lock-audit-2026-06-23T05-54-11-638Z
- Report: /Users/take/Desktop/app-contable/artifacts/runs/2026-06-23-massdte-emission-lock-audit.md
- Base status: 307
...
- Console warnings: 0
- Page errors: 0
- Failed requests: 21 (0 unexpected, 21 expected navigation aborts)
- HTTP 4xx/5xx: 0
- Findings: 0
...
|---|---|---|---|
| lock-api-before | pass | GET inicial /api/emision/jobs devolvio HTTP 200. | /tmp/massdte-lock-audit-2026-06-23T05-54-11-638Z/01-massdte-before-lock.png |
| emission-authorization | pass | Autorizacion de emision registrada para sii_local. |  |
...
| lock-ui-visible | pass | La UI muestra texto de emision bloqueada/en curso con lock activo. | /tmp/massdte-lock-audit-2026-06-23T05-54-11-638Z/02-massdte-active-lock.png |
...
- UI path: /massdte
- UI blocked text: yes
- UI screenshot: /tmp/massdte-lock-audit-2026-06-23T05-54-11-638Z/02-massdte-active-lock.png
...
### Network
- FAILED GET https://app-contable-five.vercel.app/massdte?date=2026-06-23&month=2026-5&view=day&_rsc=JWHwEFtrOzdcadjx :: net::ERR_ABORTED (esperado: navegacion Next cancelada)
...
- FAILED GET https://app-contable-five.vercel.app/massdte?date=2026-06-14&month=2026-5&view=day&_rsc=JWHwEFtrOzdcadjx :: net::ERR_ABORTED (esperado: navegacion Next cancelada)
...
- FAILED GET https://app-contable-five.vercel.app/massdte?date=2026-06-01&month=2026-5&view=day&_rsc=JWHwEFtrOzdcadjx :: net::ERR_ABORTED (esperado: navegacion Next cancelada)
...
- FAILED GET https://app-contable-five.vercel.app/massdte?date=2026-06-17&month=2026-5&view=day&_rsc=JWHwEFtrOzdcadjx :: net::ERR_ABORTED (esperado: navegacion Next cancelada)
- FAILED GET https://app-contable-five.vercel.app/massdte?month=2026-4&date=2026-06-23&view=day&_rsc=JWHwEFtrOzdcadjx :: net::ERR_ABORTED (esperado: navegacion Next cancelada)
...
- 2026-06-23T05:54:11.638Z: corrida generada por scripts/audit-emission-lock.mjs.
